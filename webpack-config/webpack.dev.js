...
const SERVICE_BASE_URL = process.env.SERVICE_BASE_URL = process.env.SERVICE_BASE_URL = 'http://itemmasterappservice-dev2.us-east-1.elasticbeanstalk.com/HSPartItemMasterAppService';
...
module.exports = webpackMerge(commonConfig, {
  ...
  plugins: [
    ...
    new ZipPlugin({
       path: '../site', 
       filename: 'Development-site' + new Date().getTime() + '.zip'
    })
  ]
});