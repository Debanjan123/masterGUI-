...
const SERVICE_BASE_URL = process.env.SERVICE_BASE_URL = 'https://item-master-app-service-qa.shs-core.com/HSPartItemMasterAppService';
...
module.exports = webpackMerge(commonConfig, {
  ...
  plugins: [
    ...
    new ZipPlugin({
       path: '../site', 
       filename: 'Staging-site' + new Date().getTime() + '.zip'
    })
  ]
});